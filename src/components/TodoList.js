...
const TodoList = () => {
  ...
  //states
  const [opnecount, countOpenTodos]=useState(0);
  ...
  return (
    <div className='shadow-sm hover:shadow-lg'>
        <div className='text-center bg-gray-900 text-white text-3xl py-4 font-semibold'>
          ...
          <input onClick={submit}  type='submit' value='Add todo' className='col-span-1 cursor-pointer'>
